...
public interface MuListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MuParser#read_func}.
	 * @param ctx the parse tree
	 */
	void enterRead_func(MuParser.Read_funcContext ctx);
	/**
	 * Exit a parse tree produced by {@link MuParser#read_func}.
	 * @param ctx the parse tree
	 */
	void exitRead_func(MuParser.Read_funcContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MuParser#print_func}.
	 * @param ctx the parse tree
	 */
	void enterPrint_func(MuParser.Print_funcContext ctx);
	/**
	 * Exit a parse tree produced by {@link MuParser#print_func}.
	 * @param ctx the parse tree
	 */
	void exitPrint_func(MuParser.Print_funcContext ctx);
	/**
